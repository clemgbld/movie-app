...
import { fakeMovieId, fakeMovieIdCaching } from "./fixtures/fakeMovieId";
...
export const serverOverideForCaching = () => {
  server.use(
    rest.get(
      `https://api.themoviedb.org/3/movie/${fakeMovieIdCaching}`,
      (req, res, ctx) => {
        return res(
          ctx.json({
            adult: false,
